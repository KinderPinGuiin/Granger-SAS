 ...
 */
final class Version20210624144943 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidature ADD offre_id INT DEFAULT NULL, CHANGE poste_id poste_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE candidature DROP offre_id, CHANGE poste_id poste_id INT NOT NULL');
    }
}
